...
- ### SplashPage
        ...
        와인퀸 웹의 스플래시 화면입니다. 와인퀸이라는 제목을 잘 나타내는 아이콘을 화면 중앙에 배치했습니다.

- ### MainPage

        사용자가 조작을 할 수 있는 Seal, Open, ResetDate 버튼이 있는 와인퀸 웹의 메인 페이지입니다. 버튼을 조작하는 대로 화면이 동작하고 사용자가 마지막 밀봉 날짜를 확인할 수 있습니다.

- ### SealPage

        카메라가 와인의 뚜껑부를 인식하고 로봇팔로 밀봉하는 과정을 MJPEG 스트리밍 방식을 통해서 웹에서 사용자에게 보여줍니다.
